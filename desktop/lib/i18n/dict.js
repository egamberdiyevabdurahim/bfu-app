...
const CORE = {
  en: {
    ...
    "nav.group.partner": "Partner",
    "nav.city": "City",
    "nav.projects": "Projects",
    "nav.roles": "Open roles",
    "nav.mentors": "Mentors",
    "nav.events": "Events",
    ...
    "nav.partner-panel": "Partner panel",
  ...
  uz: {
    ...
    "nav.group.you": "Siz",
    "nav.group.admin": "Admin",
    "nav.group.partner": "Hamkor",
    "nav.city": "Shahar",
    "nav.projects": "Loyihalar",
    "nav.roles": "Ochiq o‘rinlar",
    ...
    "nav.partner-panel": "Hamkor paneli",
  ...
  ru: {
    ...
    "nav.group.partner": "Партнёр",
    "nav.city": "Город",
    "nav.projects": "Проекты",
    "nav.roles": "Открытые роли",
    "nav.mentors": "Менторы",
    "nav.events": "События",
    ...
    "nav.partner-panel": "Панель партнёра",
