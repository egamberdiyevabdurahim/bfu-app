...
export const messages = {
  ...
  send:          (id, body, replyToId) => req(`/conversations/${id}/messages`, { method: "POST", body: JSON.stringify({ body, reply_to_id: replyToId || null }) }),
  editMessage:   (id, mid, body) => req(`/conversations/${id}/messages/${mid}`, { method: "PATCH", body: JSON.stringify({ body }) }),
  deleteMessage: (id, mid)      => req(`/conversations/${id}/messages/${mid}`, { method: "DELETE" }),
